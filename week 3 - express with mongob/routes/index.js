...
router.get('/', function(req, res, next) {
  ...
  product.find({'IsFeature':true}).populate('categoryId','Name').exec(function(err,data){
    ...
    res.render("home/index",{title:'Express Application demo',product:data,currentUser:req.user});
...
router.get('/login', function(req, res, next) {
  res.render('home/login', { title: 'Login',description:"Login  page" ,currentUser:req.user});
});
router.post('/login',
...
router.get('/signup', function(req, res, next) {
  res.render('home/signup', { title: 'signup',description:"signup  page",currentUser:req.user });
});
